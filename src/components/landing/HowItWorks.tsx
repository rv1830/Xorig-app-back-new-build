...
import { 
    ...
    Zap, AlertCircle, CheckCircle2, ArrowRight 
} from "lucide-react";
    ...
    return (
        <section className="py-24 bg-[#0B001E] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                {/* --- 2. Myth vs Reality (The Hook) --- */}
                <motion.div 
                    initial={{ opacity: 0, scale: 0.95 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 mb-24 max-w-5xl mx-auto"
                >
                    {/* Myth Side */}
                ...
                <div className="relative">
                    ...
                    <div className="hidden md:block absolute top-[145px] left-[10%] right-[10%] h-[2px] bg-gradient-to-r from-transparent via-[#ffffff]/10 to-transparent z-0">
                        {/* Moving Beam Effect */}
                        <motion.div 
                            animate={{ x: ["-100%", "100%"] }}
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <div className="relative mb-6">
                                        ...
                                        {/* Step Number Badge */}
                                        <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#240046] border border-white/10 flex items-center justify-center text-xs font-mono text-[#C77DFF]">
                                            {item.step}
                                        </div>
                                    </div>

                                    {/* Text Content */}
                                    <h4 className="text-lg font-bold text-white mb-2 group-hover:text-[#FDC500] transition-colors">
                                        {item.title}
                                    </h4>
                                    <p className="text-gray-400 text-xs leading-relaxed mb-4 min-h-[60px]">
                                        {item.desc}
                                    </p>
